...
public class RuntimeControlsPanel extends DefaultGUIPanel {
    ...
    public static final String RUNTIME_CONTROLS = "运行时控制";

    public static final String DATA_WRITING_LABEL = "数据写入";
    public static final String TIME_SETTINGS_LABEL = "时间设置";
    public static final String GRAPH_FORMAT_LABEL = "图形格式";
    public static final String TIME_PRECISION_LABEL = "时间精度";
    public static final String TIME_FORMAT_LABEL = "时间格式";
    public static final String WRITE_COMPRESSION_LABEL = "压缩写入";
    public static final String WRITE_PRECISION_LABEL = "写入精度";
    public static final String WRITE_FORMAT_LABEL = "写入格式";
    public static final String PURGE_WRITE_LABEL = "清除写入";
    public static final String WRITE_CONTROL_LABEL = "写入控制";
    public static final String MAX_TIME_STEP_LABEL = "最大时间步 " + Symbols.S;
    public static final String MAX_COURANT_ALPHA_LABEL = "最大 Courant Alpha";
    public static final String MAX_COURANT_NUMBER_LABEL = "最大 Courant Number";
    public static final String ADJUSTABLE_TIME_STEP_LABEL = "可调整时间步";
    public static final String DELTA_T_LABEL = Symbols.DELTA_T + Symbols.S;
    public static final String END_TIME_LABEL = "结束时间步";
    public static final String START_FROM_LABEL = "开始时间步";
    ...
    public static final String RAW_LABEL = "原始值";
    // public static final String SCIENTIFIC_LABEL = "Scientific";
    // public static final String FIXED_LABEL = "Fixed";
    public static final String GENERAL_LABEL = "通用";
    public static final String COMPRESSED_LABEL = "压缩";
    public static final String UNCOMPRESSED_LABEL = "非压缩";
    // public static final String BINARY_LABEL = "Binary";
    public static final String ASCII_LABEL = "ASCII";
    public static final String CLOCK_TIME_LABEL = "时钟时间步";
    public static final String CPU_TIME_LABEL = "CPU 时间步";
    public static final String RUN_TIME_LABEL = "运行时间步";
    public static final String TIME_STEP_LABEL = "时间步长";
    public static final String START_TIME_LABEL = "起始时间步";
    public static final String LATEST_TIME_LABEL = "最后时间步";
    public static final String FIRST_TIME_LABEL = "最初时间步";
