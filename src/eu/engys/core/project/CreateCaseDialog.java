...
import eu.engys.util.DialogExitStatus;
...
public class CreateCaseDialog extends JPanel {
    ...
    private DialogExitStatus status = DialogExitStatus.ERROR;
    ...
    private void checkStatus() {
        ...
        if (parentPath.isEmpty()) {
            ...
            status = DialogExitStatus.CANCEL;
        } else {
    ...
    public boolean isOK() {
        return status == DialogExitStatus.OK;
    }

    public boolean isError() {
        return status == DialogExitStatus.ERROR;
    }

    public boolean isCancel() {
        return status == DialogExitStatus.CANCEL;
    }
